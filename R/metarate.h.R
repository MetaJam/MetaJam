...
metaRateOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaRateOptions",
    ...
    public = list(
        initialize = function(
            ...
            prediction = FALSE,
            confidenceLevel = 95,
            nullEffectEnabled = FALSE,
            nullEffect = 1,
            irscaleEnabled = FALSE,
            irscale = 1000,
            irunit = "person-years",
            summary = TRUE,
            forestPlot = TRUE,
            ...
            leaveOneOutXlimLower = 0,
            leaveOneOutXlimUpper = 1,
            ...
            cumulativeXlimLower = 0,
            cumulativeXlimUpper = 1,
            ...
            private$..confidenceLevel <- jmvcore::OptionNumber$new(
                ...
                max=99.9,
                default=95)
            private$..nullEffectEnabled <- jmvcore::OptionBool$new(
                "nullEffectEnabled",
                nullEffectEnabled,
                default=FALSE)
            private$..nullEffect <- jmvcore::OptionNumber$new(
                "nullEffect",
                nullEffect,
                min=0,
                default=1)
            private$..irscaleEnabled <- jmvcore::OptionBool$new(
                "irscaleEnabled",
                irscaleEnabled,
                default=FALSE)
            private$..irscale <- jmvcore::OptionNumber$new(
                "irscale",
                irscale,
                min=1,
                default=1000)
            private$..irunit <- jmvcore::OptionString$new(
                "irunit",
                irunit,
                default="person-years")
            ...
            private$..digitsEffect <- jmvcore::OptionList$new(
                ...
                options=list(
                    ...
                    "5"),
                default="2")
            private$..digitsTime <- jmvcore::OptionList$new(
                "digitsTime",
                digitsTime,
                options=list(
                    "auto",
            ...
            private$..subgroupDigitsEffect <- jmvcore::OptionList$new(
                ...
                options=list(
                    ...
                    "5"),
                default="2")
            private$..subgroupDigitsTime <- jmvcore::OptionList$new(
                "subgroupDigitsTime",
                subgroupDigitsTime,
                options=list(
                    "auto",
            ...
            self$.addOption(private$..nullEffectEnabled)
            self$.addOption(private$..nullEffect)
            self$.addOption(private$..irscaleEnabled)
            self$.addOption(private$..irscale)
            self$.addOption(private$..irunit)
            ...
            self$.addOption(private$..digitsTime)
            ...
            self$.addOption(private$..subgroupDigitsTime)
    ...
    active = list(
        ...
        nullEffectEnabled = function() private$..nullEffectEnabled$value,
        nullEffect = function() private$..nullEffect$value,
        irscaleEnabled = function() private$..irscaleEnabled$value,
        irscale = function() private$..irscale$value,
        irunit = function() private$..irunit$value,
        ...
        digitsTime = function() private$..digitsTime$value,
        ...
        subgroupDigitsTime = function() private$..subgroupDigitsTime$value,
...
metaRateResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaRateResults",
    ...
    public=list(
        initialize=function(options) {
            super$initialize(
                options=options,
                name="",
                title="Single Incidence Rates Meta-Analysis")
...
metaRateBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaRateBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = metaRateResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#' Single Incidence Rates Meta-Analysis
#'
#' 
#' @param data .
#' @param studyLabel .
...
#' @param nullEffectEnabled .
#' @param nullEffect .
#' @param irscaleEnabled .
#' @param irscale .
#' @param irunit .
#' @param summary .
#' @param forestPlot .
...
metaRate <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("metaRate requires jmvcore to be installed (restart may be required)")
    ...
    options <- metaRateOptions$new(
        ...
        nullEffectEnabled = nullEffectEnabled,
        nullEffect = nullEffect,
        irscaleEnabled = irscaleEnabled,
        irscale = irscale,
        irunit = irunit,
        summary = summary,
        ...
        subgroupDigitsTime = subgroupDigitsTime,
