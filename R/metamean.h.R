...
metaMeanOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaMeanOptions",
...
metaMeanResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaMeanResults",
    ...
    public=list(
        initialize=function(options) {
            super$initialize(
                options=options,
                name="",
                title="Single Means Meta-Analysis")
...
metaMeanBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaMeanBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = metaMeanResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
metaMean <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("metaMean requires jmvcore to be installed (restart may be required)")
