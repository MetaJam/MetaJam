...
metaPropOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaPropOptions",
    ...
    public = list(
        initialize = function(
            ...
            private$..nullEffect <- jmvcore::OptionNumber$new(
                ...
                max=1,
                default=0.5)
            private$..pscaleEnabled <- jmvcore::OptionBool$new(
                "pscaleEnabled",
                pscaleEnabled,
                default=FALSE)
            private$..pscale <- jmvcore::OptionNumber$new(
                "pscale",
                pscale,
                min=1,
                default=1000)
            ...
            self$.addOption(private$..pscaleEnabled)
            self$.addOption(private$..pscale)
    ...
    active = list(
        ...
        pscaleEnabled = function() private$..pscaleEnabled$value,
        pscale = function() private$..pscale$value,
...
metaPropResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaPropResults",
    ...
    public=list(
        initialize=function(options) {
            super$initialize(
                options=options,
                name="",
                title="Single Proportions Meta-Analysis")
            ...
            self$add(jmvcore::Image$new(
                ...
                visible="(asymmetryTest && asymmetryPlot && !(asymmetryMethod %in% c(\"Macaskill\", \"Peters\")))",
                clearWith=list(
                    "studyLabel",
                    "event",
                    "n",
...
metaPropBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaPropBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = metaPropResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#' Single Proportions Meta-Analysis
#'
#' 
#' @param data .
#' @param studyLabel .
...
metaProp <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("metaProp requires jmvcore to be installed (restart may be required)")
