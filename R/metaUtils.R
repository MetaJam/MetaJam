...
stripModel <- function(model) {
  ...
  # TODO: Before adding a MetaJam metagen analysis, decide how to handle a
  # MetaJam-configured func.backtransf for the selected effect-size measure.
  # It may retain a large closure environment, but stripping it would break
  # the intended back-transformation.
